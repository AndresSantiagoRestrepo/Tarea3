...
public class ControlEstudiante {
    ...
    private String line;
    // y aqui se guardaran separados los atributos de cada estudiante, teniendo en
    // cuenta que la posicion 0 tiene id, 1 el nombre y 2 el apellido
    ...
    public void leerCSV(String ruta) {
        try {
            ...
            System.out.println("Error: No se encontro un archivo con ese nombre");
        }
    ...
    public void escribirJSON() {
        ...
        for (Estudiante estud : estudiantes) {
            // Aqui creo un objeto de tipo JsonObjecto con los atributos de un estudiante,
            // luego este jsonObjecto lo envio al array para que esté con otros estudiantes
        ...
        // Aqui se convierten los jsonObject del array en una cadena String para que sea
        // escrita en el JSON
        String jsonStr = estudianteRecorrido.toString();

        // Luego aqui se efectua la escritura del archivo estudiantes.json, en el caso
        // de que el archivo no exista, entonces se creará
        try (FileWriter fileWriter = new FileWriter(
                "src\\main\\resources\\estudiantes.json")) {
    ...
    // C:\Users\Stokker\Documents\Software
    // 1\tarea3\src\main\resources\estudiantes.csv
    public void print() {
